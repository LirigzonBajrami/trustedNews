  ...
  <div class="container">
      ...
      <div class="row ">
        <div class="col-lg-8">
          ...
          <?php if(is_active_sidebar('last-post-shendetesi')): ?>
              <div class="last-post">
                <?php dynamic_sidebar('last-post-shendetesi'); ?>
        ...
        <div class="col-lg-4">
        <?php if(is_active_sidebar('last-posts-shendetesi-sidebar')): ?>
              <div>
                <?php dynamic_sidebar('last-posts-shendetesi-sidebar'); ?>
              </div>
          <?php endif; ?>
        </div>
      </div>
