  ...
  <div class="container">
      ...
      <div class="row ">
        <div class="col-lg-8">
          ...
          <?php if(is_active_sidebar('last-post-sport')): ?>
              <div class="last-post">
                <?php dynamic_sidebar('last-post-sport'); ?>
        ...
        <div class="col-lg-4">
        <?php if(is_active_sidebar('last-posts-sport-sidebar')): ?>
              <div>
                <?php dynamic_sidebar('last-posts-sport-sidebar'); ?>
              </div>
          <?php endif; ?>
        </div>
      </div>
